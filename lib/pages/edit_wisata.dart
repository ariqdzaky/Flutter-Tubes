...
class FormEditData extends StatefulWidget {
  ...
  @override
  _FormEditDataScreenState createState() => _FormEditDataScreenState();
}

class _FormEditDataScreenState extends State<FormEditData> {
              ...
              InkWell(
                onTap: () {
                  ...
                  if (nama.text.isNotEmpty &&
                      ...
                      lat != '0' &&
                      lng != '0') {
                    provider.editWisata(context, widget.docname!, nama.text,
                        alamat.text, deskripsi.text, valueImage, lat, lng);
                  } else {
